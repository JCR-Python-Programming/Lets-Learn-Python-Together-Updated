# Try this fun tkinter Python program example, I call LASER WARS II
...
while True:
    ...
    y1 = randint(-1920,1920)
    x2 = randint(-1920,1920)
    y2 = randint(-1920,1920)

    x3 = randint(-1920,1920)
    y3 = randint(-1920,1920)
    x4 = randint(-1920,1920)
    y4 = randint(-1920,1920)

    x5 = randint(-1920,1920)
    y5 = randint(-1920,1920)
    x6 = randint(-1920,1920)
    y6 = randint(-1920,1920)
    
    x7 = randint(-1920,1920)
    y7 = randint(-1920,1920)
    x8 = randint(-1920,1920)
    y8 = randint(-1920,1920)
    
    x9 = randint(-1920,1920)
    y9 = randint(-1920,1920)
    x10 = randint(-1920,1920)
    y10 = randint(-1920,1920)

    x11 = randint(-1920,1920)
    y11 = randint(-1920,1920)
    x12 = randint(-1920,1920)
    y12 = randint(-1920,1920)

    x13 = randint(-1920,1920)
    y13 = randint(-1920,1920)
    x14 = randint(-1920,1920)
    y14 = randint(-1920,1920)

    x15 = randint(-1920,1920)
    y15 = randint(-1920,1920)
    x16 = randint(-1920,1920)
    y16 = randint(-1920,1920)

    x17 = randint(-1920,1920)
    y17 = randint(-1920,1920)
    x18 = randint(-1920,1920)
    y18 = randint(-1920,1920)

    x19 = randint(-1920,1920)
    y19 = randint(-1920,1920)
    ...
    laser_canvas.create_line(x13,y13,x14,y14,fil = random_colour_code(),width = random_width)
