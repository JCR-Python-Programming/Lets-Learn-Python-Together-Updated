...
while True:
    ...
    my_canvas.create_oval(x1,y1,x2,y2,fill=random_colour_code(),width=random_width)
    my_canvas.create_rectangle(x3,y3,x4,y4,fill=random_colour_code(),width=random_width)
