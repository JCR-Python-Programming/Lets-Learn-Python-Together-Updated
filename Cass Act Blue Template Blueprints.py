...
Main(
  ...
  kwarg9 = 'karg9',kwarg10 = 'karg10').class_data()
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
class Main:
...
class Grandfather:
  def __init__(self, grandfather1,grandfather2,grandfather3):
...
class Child(Names1,Names2,Names3):
...
class Child(Names3,Names2,Names1):
  def __init__(self,name1,name2,name3,name4,name5,name6):
...
class Names2:
  def __init__(self,name3,name4,**kwargs):

    self.name3 = 'Tom'
    self.name4 = 'John'

class Names3:
  def __init__(self,name5,name6,**kwargs):
...
class Child(Names1,Names2,Names3):
  def __init__(self,name1,name2,name3,name4,name5,name6):
    ...
    Names1.__init__(self, name1 = name1, name2 = name2)
    Names2.__init__(self, name3 = name3, name4 = name4)
    Names3.__init__(self, name5 = name6, name6 = name6)
